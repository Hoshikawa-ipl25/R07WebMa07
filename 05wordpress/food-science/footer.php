...
if (is_home()) {
  ...
  //↓scinceのスペルが間違っていたので修正しました 
  wp_enqueue_script('food-scinece-home', get_template_directory_uri() . '/assets/js/home.js');
}
?>

<!-- wp_footer() </body>の閉じタグの手前に必ず書く　WPテンプレートに必須の関数のひとつ -->
<?php wp_footer(); ?>
</body>
