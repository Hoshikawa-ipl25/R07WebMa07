<?php
wp_enqueue_style('fotoroma', 'https://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.css');
wp_enqueue_script('fotoroma', 'https://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.js', ['jquery'])
?>
